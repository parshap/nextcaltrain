...
module.exports = function(store, opts) {
  ...
  return new Schedule(store, stopTimes, opts.date);
};

// ### Schedule
//

var Schedule = function(store, stopTimes, date) {
...
function filterTripsIncludingStops(store, trips, stops) {
  ...
  return trips.filter(function(trip) {
    var stopTimes = getStopTimesOnTrip(store, trip);
...
function getStopTimesOnTrip(store, trip) {
  return filterStopTimesOnTrips(store.stopTimes, [trip]);
}
